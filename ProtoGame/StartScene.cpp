...
void StartScene::InitializeScene()
{
	...
	//
	// ImageComponent* pRenderBackground{ new ImageComponent(pBackground, Proto::TextureData{}) };
	// ImageComponent* pRenderLogo{ new ImageComponent(pLogo, Proto::TextureData{ 216, 180 }) };
	//
